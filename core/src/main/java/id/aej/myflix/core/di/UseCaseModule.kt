...
import id.aej.myflix.core.data.interactors.UserInteractors
...
class UseCaseModule {
  ...
  @Provides
  fun userUseCase(userRepository: UserRepository): UserUseCase = UserInteractors(userRepository, Dispatchers.IO)
}